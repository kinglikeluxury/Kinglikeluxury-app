...
export const KAY_DATA_OWNERSHIP: readonly KayDataObject[] = Object.freeze([
  ...
  { name: "kay_voice_one_turn_sessions", owner: "KAY_OWNED", runtimeWrite: true, note: "Single-use internal voice turn state only; no CRM or customer data." },
