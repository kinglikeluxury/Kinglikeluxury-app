...
export interface IStorage {
  ...
  // CRM lead operations
  getCrmLeads(filters?: { search?: string; status?: string; source?: string; assignedTo?: number | null; expectedMonth?: string; contactDate?: string; sortOrder?: "newest" | "oldest"; limit?: number; offset?: number; qualScore?: string }): Promise<{ leads: (import("@shared/schema").CrmLead & { assigneeName?: string | null })[]; total: number }>;
