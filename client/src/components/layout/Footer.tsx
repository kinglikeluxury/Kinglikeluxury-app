        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <div className="mt-4 flex space-x-4">
              ...
              <a href="https://www.instagram.com/kinglike.luxury/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
              ...
              <a href="https://www.youtube.com/@KinglikeLuxury" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
                <span className="sr-only">YouTube</span>
                <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                  <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
                </svg>
              </a>
              <a href="https://wa.me/995591000059" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="flex items-start">
                ...
                <a href="mailto:info@kinglikeluxury.com" className="hover:text-white">info@kinglikeluxury.com</a>
              </li>
              <li className="flex items-start">
                <Phone className="h-5 w-5 mr-2 mt-0.5" />
                <a href="tel:+995591000058" className="hover:text-white">+995 59 10000 58</a>
              </li>
            </ul>
          </div>
        </div>
