...
const PETRA_APT_COORDS: Record<string, [number, number, number, number]> = {
  ...
  // Calibrated: rooms start at x=0.107 (shifted +0.025 right after user feedback)
  // 11 rooms before elevator core: width = (0.667-0.107)/11 = 0.051 each
  "03": [0.107, 0.162, 0.158, 0.487],
  "05": [0.158, 0.162, 0.209, 0.487],
  "07": [0.209, 0.162, 0.260, 0.487],
  "09": [0.260, 0.162, 0.311, 0.487],
  "11": [0.311, 0.162, 0.362, 0.487],
  "13": [0.362, 0.162, 0.413, 0.487],
  "15": [0.413, 0.162, 0.464, 0.487],
  "17": [0.464, 0.162, 0.515, 0.487],
  "19": [0.515, 0.162, 0.566, 0.487],
  "21": [0.566, 0.162, 0.617, 0.487],
  "23": [0.617, 0.162, 0.667, 0.487],
  ...
  "02": [0.107, 0.565, 0.158, 0.897],
  "04": [0.158, 0.565, 0.209, 0.897],
  "06": [0.209, 0.565, 0.260, 0.897],
  "08": [0.260, 0.565, 0.311, 0.897],
  "10": [0.311, 0.565, 0.362, 0.897],
  "12": [0.362, 0.565, 0.413, 0.897],
  "14": [0.413, 0.565, 0.464, 0.897],
  "16": [0.464, 0.565, 0.515, 0.897],
  "18": [0.515, 0.565, 0.566, 0.897],
  "20": [0.566, 0.565, 0.617, 0.897],
  "22": [0.617, 0.565, 0.667, 0.897],
  // elevator core x 0.667–0.742
