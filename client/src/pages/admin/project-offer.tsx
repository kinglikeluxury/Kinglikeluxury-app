...
// y calibration: building top ≈ 0.320, building bottom ≈ 0.740
// North row y: 0.320–0.490 | corridor gap | South row y: 0.530–0.740
const PETRA_APT_COORDS: Record<string, [number, number, number, number]> = {
  // ── Left corner unit (spans full building height) ─────────────────────
  "01": [0.022, 0.320, 0.082, 0.740],
  // ── North row (sea-facing, top)  y: 0.320 – 0.490 ────────────────────
  // 11 rooms before elevator core: x start=0.107, width per room=0.051
  "03": [0.107, 0.320, 0.158, 0.490],
  "05": [0.158, 0.320, 0.209, 0.490],
  "07": [0.209, 0.320, 0.260, 0.490],
  "09": [0.260, 0.320, 0.311, 0.490],
  "11": [0.311, 0.320, 0.362, 0.490],
  "13": [0.362, 0.320, 0.413, 0.490],
  "15": [0.413, 0.320, 0.464, 0.490],
  "17": [0.464, 0.320, 0.515, 0.490],
  "19": [0.515, 0.320, 0.566, 0.490],
  "21": [0.566, 0.320, 0.617, 0.490],
  "23": [0.617, 0.320, 0.667, 0.490],
  // elevator core x 0.667–0.742
  "25": [0.742, 0.320, 0.801, 0.490],
  "27": [0.801, 0.320, 0.860, 0.490],
  "29": [0.860, 0.320, 0.919, 0.490],
  "31": [0.919, 0.320, 0.979, 0.490],
  // ── South row (garden-facing, bottom)  y: 0.530 – 0.740 ──────────────
  "02": [0.107, 0.530, 0.158, 0.740],
  "04": [0.158, 0.530, 0.209, 0.740],
  "06": [0.209, 0.530, 0.260, 0.740],
  "08": [0.260, 0.530, 0.311, 0.740],
  "10": [0.311, 0.530, 0.362, 0.740],
  "12": [0.362, 0.530, 0.413, 0.740],
  "14": [0.413, 0.530, 0.464, 0.740],
  "16": [0.464, 0.530, 0.515, 0.740],
  "18": [0.515, 0.530, 0.566, 0.740],
  "20": [0.566, 0.530, 0.617, 0.740],
  "22": [0.617, 0.530, 0.667, 0.740],
  // elevator core x 0.667–0.742
  "24": [0.742, 0.530, 0.789, 0.740],
  "26": [0.789, 0.530, 0.836, 0.740],
  "28": [0.836, 0.530, 0.883, 0.740],
  "30": [0.883, 0.530, 0.930, 0.740],
  "32": [0.930, 0.530, 0.979, 0.740],
};
