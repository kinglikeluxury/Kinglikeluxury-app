...
// Calibrated from user feedback: apt 26 confirmed at x=[0.403,0.461], apt width ≈ 0.058
// Top main row: 21-31 (left→right), corners: 17(L) 32(R)
// Bottom main row: 11-01 (left→right, decreasing), corners: 15(L) 00(R)
// Left cluster (Mountain View): 17,16,15 + 18,19,20,12,13,14 stacked
// Right cluster (Sea View): 32,33,00
const SILK_APT_COORDS: Record<string, [number, number, number, number]> = {
  // ── Top row — City View (north side) ──────────────────────────────
  "17": [0.068, 0.300, 0.113, 0.498], // corner left
  "21": [0.113, 0.300, 0.171, 0.498],
  "22": [0.171, 0.300, 0.229, 0.498],
  "23": [0.229, 0.300, 0.287, 0.498],
  "24": [0.287, 0.300, 0.345, 0.498],
  "25": [0.345, 0.300, 0.403, 0.498],
  "26": [0.403, 0.300, 0.461, 0.498], // ← verified correct by user
  "27": [0.461, 0.300, 0.519, 0.498],
  "28": [0.519, 0.300, 0.577, 0.498],
  "29": [0.577, 0.300, 0.635, 0.498],
  "30": [0.635, 0.300, 0.693, 0.498],
  "31": [0.693, 0.300, 0.751, 0.498],
  "32": [0.751, 0.300, 0.963, 0.498], // corner right (Sea View top)
  // ── Mountain View left side cluster ───────────────────────────────
  "18": [0.068, 0.300, 0.113, 0.366], // stacked upper-left
  "19": [0.068, 0.366, 0.113, 0.432],
  "20": [0.068, 0.432, 0.113, 0.498],
  "16": [0.068, 0.498, 0.113, 0.574], // corridor-level side studio
  "12": [0.068, 0.574, 0.113, 0.640], // stacked lower-left
  "13": [0.068, 0.640, 0.113, 0.706],
  "14": [0.068, 0.706, 0.113, 0.820],
  // ── Bottom row — Park View (south side) ───────────────────────────
  "15": [0.068, 0.574, 0.113, 0.820], // corner left
  "11": [0.113, 0.574, 0.171, 0.820],
  "10": [0.171, 0.574, 0.229, 0.820],
  "09": [0.229, 0.574, 0.287, 0.820],
  "08": [0.287, 0.574, 0.345, 0.820],
  "07": [0.345, 0.574, 0.403, 0.820],
  "06": [0.403, 0.574, 0.461, 0.820],
  "05": [0.461, 0.574, 0.519, 0.820],
  "04": [0.519, 0.574, 0.577, 0.820],
  "03": [0.577, 0.574, 0.635, 0.820],
  "02": [0.635, 0.574, 0.693, 0.820],
  "01": [0.693, 0.574, 0.751, 0.820],
  "00": [0.751, 0.574, 0.963, 0.820], // corner right (Sea View bottom)
  // ── Sea View right side middle ─────────────────────────────────────
  "33": [0.751, 0.498, 0.963, 0.574],
};
