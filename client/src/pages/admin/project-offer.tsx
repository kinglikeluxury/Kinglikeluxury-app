...
const AMBASSADORI_APT_COORDS: Record<string, [number, number, number, number]> = {
  ...
  // elevator core x 0.416–0.571 (wider than one slot)
  // apt 12 visual centre ≈ 0.610; slot width ≈ 0.063; apt width 0.057
  "12": [0.581, 0.161, 0.638, 0.532],
  "14": [0.644, 0.161, 0.701, 0.532],
  "16": [0.707, 0.161, 0.764, 0.532],
  "18": [0.770, 0.161, 0.827, 0.532],
  "20": [0.833, 0.161, 0.890, 0.532],
  "22": [0.896, 0.161, 0.953, 0.532],
